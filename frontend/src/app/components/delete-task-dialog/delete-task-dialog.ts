...
import { MAT_DIALOG_DATA, MatDialogRef, MatDialogActions, MatDialogClose, MatDialogTitle, MatDialogContent } from '@angular/material/dialog';
...
export class DeleteTaskDialog {
    ...
    protected onDelete() {
        this.saving = true;
        this.tasksService.deleteTask(this.data.task.id)
